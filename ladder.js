   ...
   $('#zoomReset').click(function() {
    ...
    function userSetting(memberCount) {
        ...
        selectedUsers.forEach(function (user, i) {
            ...
            html += '<input maxlength="3" type="text" value="' + user.name + '" data-node="' + i + '-0" disabled style="width:100px; text-align: center; border: none; font-size: 16px; padding-right:50px; background-color:transparent;">';
